...
public class CardConsumer {
	...
	public static String createTx(String data) {
		String URL="http://localhost:8012/MiniProjectProducerApp/rest/payment/dopayment";
		String msg=null;
		try {
	...
	public static String viewAllTx() {
		String URL="http://localhost:8012/MiniProjectProducerApp/rest/payment/getall";
		String msg=null;
		try {
			Client c=Client.create();
			WebResource wr=c.resource(URL);
	...
	public static String getOneTx(String txid) {
		String URL="http://localhost:8012/MiniProjectProducerApp/rest/payment/getone?txid=";
		String msg=null;
		if(txid!=null) {
			try {
				Client c=Client.create();
